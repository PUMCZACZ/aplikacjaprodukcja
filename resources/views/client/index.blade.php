    ...
    <section class="py-2 px-4 mx-auto">
        <x-table.layout>
            ...
            @foreach($clients as $client)
                <tbody>
                <tr>
                    <x-table.ahref-body-section
                        :href="route('clients.show', $client->id)">{{ $client->name}}</x-table.ahref-body-section>
                    ...
                    <x-table.paragraph-body-section>
                        @if($client->name_of_company === null)
                            Brak Danych
                        @else
                            {{ $client->name_of_company }}
                        @endif
                    </x-table.paragraph-body-section>
