    ...
    <section class="py-2 px-4 mx-auto">
        <x-table.layout>
            ...
            <tr>
                ...
                <x-table.ahref-head-section :href="route('orders.create')">Dodaj Zamównienie
                </x-table.ahref-head-section>
            </tr>
            </thead>
            @foreach($orders as $order)
                ...
                <x-table.edit-button :href="route('orders.confirm', $order->id)">Zatwierdź</x-table.edit-button>
